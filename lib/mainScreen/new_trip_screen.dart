...
class _NewTripScreenState extends State<NewTripScreen>
{
  ...
  getDriversLocationUpdateAtRealTime()
  {
        ...
        .listen((Position position)
    {
      ...
      //update driver location at real time database
  ...
  updateDurationTimeAtRealTime() async
  {
    if(isRequestDirectionDetails == false)
    {
      ...
      if(onlineDriverCurrentPosition == null) //if error happened
      {
        return;
      }
  ...
  endTripNow() async
  {
    ...
    //get tripDirectionDetails to avoid scammers
  ...
  saveAssignedDriverDetailsToUserRideRequest()
  {
    ...
    databaseReference.child("driver_details").set(onlineDriverData.car_color.toString() + " " + onlineDriverData.car_model.toString() + " " + onlineDriverData.car_number.toString());
  ...
  // saveRideRequestIdToDriverHistory()
  // {
  //   DatabaseReference tripHistoryRef = FirebaseDatabase.instance.ref()
  //       .child("drivers")
  //       .child(currentFirebaseUser!.uid)
  //       .child("tripHistory");
  //
